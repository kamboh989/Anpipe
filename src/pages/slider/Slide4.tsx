    ...
    <div className="sticky top-0 w-full h-screen flex justify-center items-center relative font-sans">
      ...
      <div className="absolute inset-0 p-0 sm:p-12 md:p-16 lg:p-13">
        <img
          src="/Slider04.png"
          alt="Slide 4"
          className="w-full h-full object-cover sm:object-fit brightness-75 rounded-none sm:rounded-4xl shadow-lg border border-gray-600"
        />
      </div>
      ...
      >
        <h1 className="text-4xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold mb-4 leading-snug sm:leading-tight md:leading-tight tracking-tight text-white font-heading uppercase">
