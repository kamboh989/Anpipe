...
export default function Slide3() {
  ...
  return (
    <div className="sticky top-0 w-full h-screen flex justify-center items-center relative font-roboto">
      ...
      >
        <h1 className="text-4xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 leading-snug sm:leading-tight md:leading-tight tracking-tight text-white" style={{ fontFamily: "'Altmann Grotesk', sans-serif" }}>
          Quality You Can Trust        </h1>
        ...
        <p className="text-white text-xl sm:text-lg md:text-lg lg:text-xl leading-relaxed font-normal mb-6 max-w-full sm:max-w-xl md:max-w-2xl lg:max-w-3xl px-2" style={{ fontFamily: "'Fenomen Sans', sans-serif" }}>
          Manufactured from prime materials and certified to international standards, each pipe is inspected for accuracy, strength, and longevity.        </p>
